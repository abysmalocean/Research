...
struct aersl5_1_ 
{
    integer isave, icondn, igrid, iprnt, iptim, iread, isetsw, isetup, ispswt,
	     isplin, isstat, iswtch, issflg, itimdp, ncremv, ncsorc, ndcls[20]
	    , ndiscr, ndremv, ndsorc, nmulp1, nmxvar, nprnt, nptbet, nquadp, 
	    nvar, nvart, nvarp1, nvarp2, nvarm1, maxevp, minw;
};
...
/* Main program */ int MAIN__(void)
{
    ...
    static char fmt_4[] = "(\0020*** SOMETHING IS WRONG, MORE THAN 500 STEPS"
	    " NEEDED TO REACH TIME=\002,e10.4,\002, RECHECK INPUT OR CONTACT "
	    "FRED GELBARD\002)";
    ...
    /* Local variables */
    static integer i__;
    extern /* Subroutine */ int ode_(U_fp, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     doublereal *, integer *);
    static doublereal time, work[1360];
    extern /* Subroutine */ int check_(integer *);
    static integer icase;
    static doublereal asave[20];
    static integer iwork[5], istop;
    extern /* Subroutine */ int input_(void), setup_(integer *, integer *, 
	    integer *), coagcf_(integer *), chktbl_(integer *);
    extern /* Subroutine */ int diffun_();
    static integer maxcas, iodepk;
    extern /* Subroutine */ int steady_(doublereal *);
...
/* Subroutine */ int input_(void)
{
    ...
    static char fmt_3[] = "(\0021\002,43x,10a4/\0020SMALLEST PARTICLE VOLUM"
	    "E\002,e33.4,11x,\002LARGEST PARTICLE VOLUME\002,e28.4/\0020RELAT"
	    "IVE INTEGRATION ERROR\002,e29.4,11x,\002ABSOLUTE INTEGRATION ERR"
	    "OR\002,e23.4/\0020TOTAL NUMBER OF GRID POINTS\002,i26,13x,\002MA"
	    "XIMUM NUMBER OF GRID POINTS\002,i18,/\0020NUMBER OF DISCRETE SIZ"
	    "ES\002,i29,13x,\002NUMBER OF MULTIPLETS GIVEN\002,i21,/\0020NUMB"
	    "ER OF OUTPUT TIMES\002,i31,13x,\002SWITCH INTERPOLATION AT OUTPU"
	    "T NUMBER\002,i10/\0020STEADY STATE AT OUTPUT NUMBER\002,i24,13x"
	    ",\002NUMBER OF GRID POINTS GIVEN\002,i20/\0020NUMBER OF INTERPOL"
	    "ATING POINTS\002,i23,13x,\002NUMBER OF CONTINUOUS SOURCE TERM"
	    "S\002,i14)";
    static char fmt_4[] = "(\0020NUMBER OF CONTINUOUS REMOVAL TERMS\002,i19,"
	    "13x,\002NUMBER OF DISCRETE SOURCE TERMS\002,i16/\0020NUMBER OF D"
	    "ISCRETE REMOVAL TERMS\002,i21,13x,\002CONDENSATION (0=NO/1=YES"
	    ")\002,i22/\0020INITIAL SPLINE INTERPOLATION METHOD NUMBER\002,i1"
	    "1,13x,\002CALL SETUP BEFORE INTERPOLATING (0=NO/1=YES)\002,i3"
	    "/\0020SPLINE NUMBER FOR SWITCHED METHOD\002,i20,13x,\002CALL SET"
	    "UP FOR SWITCHED METHOD (0=NO/1=YES)\002,i4/\0020TIME DEPENDENT C"
	    "OAG./EVAP. COEFFICIENT (0=NO/1=YES)\002,i2,13x,\002USER SUPPLIED"
	    " PARAMETER SWITCHES\002,5x,10i2)";
    static char fmt_5[] = "(8e10.4)";
    static char fmt_23[] = "(/55x,\002OUTPUT TIMES\002/\0020NO.\002,7x,\002T"
	    "IME\002,6x,\002NO.\002,7x,\002TIME\002,6x,\002NO.\002,7x,\002TIME"
	    "\002,6x,\002NO.\002,7x,\002TIME\002,6x,\002NO.\002,7x,\002TIM"
	    "E\002,6x,\002N0.\002,7x,\002TIME\002/6(i3,e14.4,3x))";
    ...
    static char fmt_12[] = "(//55x,\002GRID POINTS\002/\0020NO.\002,7x,\002S"
	    "IZE\002,6x,\002NO.\002,7x,\002SIZE\002,6x,\002NO.\002,7x,\002SIZE"
	    "\002,6x,\002NO.\002,7x,\002SIZE\002,6x,\002NO.\002,7x,\002SIZ"
	    "E\002,6x,\002N0.\002,7x,\002SIZE\002/6(i3,e14.4,3x))";
...
/* Subroutine */ int output_(integer *istop)
{
    ...
    static char fmt_6[] = "(\0021\002,49x,\002TIME =\002,e10.4,\002        "
	    " \002//22x,\002PARTICLE\002,10x,\002PARTICLE\002,6x,\002DN/ALOG("
	    "DP)\002,10x,\002DS/ALOG(DP)\002,3x,\002DV/ALOG(DP)\002/23x,\002V"
	    "OLUME\002,11x,\002DIAMETER\002,8x,\002DISTRIBUTION\002,6x,\002DI"
	    "STRIBUTION\002,6x,\002DISTRIBUTION\002/19x,\002V (CC)\002,11x"
	    ",\002D (CM)\002,13x,\002N(LOG(D))\002,10x,\002S(LOG(D))\002,8x"
	    ",\002V(LOG(D))\002/13x,\002NO.\002,9x,\002  \002,16x,\002  \002,"
	    "14x,\002    \002,13x,\002        \002,11x,\002     \002/)";
    ...
    static char fmt_13[] = "(/20x,\002MEAN VOLUME\002,6x,\002MEAN DIAMETE"
	    "R\002,5x,\002TOTAL NUMBER\002,4x,\002TOTAL SURFACE AREA\002,3x"
	    ",\002TOTAL VOLUME\002/24x,\002  \002,16x,\002  \002,16x,\002   "
	    " \002,12x,\002        \002,11x,\002     \002/e30.4,4e18.4)";
    ...
    static char fmt_9[] = "(//53x,\002DISCRETE REGIME\002//22x,\002PARTICL"
	    "E\002,10x,\002PARTICLE\002,11x,\002NUMBER\002,9x,\002SURFACE AREA"
	    "\002,8x,\002VOLUME\002/23x,\002VOLUME\002,11x,\002DIAMETER\002,7"
	    "x,\002CONCENTRATION\002,6x,\002CONCENTRATION\002,4x,\002CONCENTR"
	    "ATION\002/25x,\002V\002,17x,\002D\002,17x,\002N\002,18x,\002S"
	    "\002,16x,\002V\002/13x,\002NO.\002,9x,\002  \002,16x,\002  \002,"
	    "14x,\002    \002,13x,\002        \002,11x,\002     \002/)";
...
/* Subroutine */ int chktbl_(integer *istop)
{
    ...
    static char fmt_11[] = "(15x,\002TIME STEP WILL BE RETRIED WITH THE ADDI"
	    "TION OF THE FIRST\002,i3,\002 OF THE ABOVE POINTS IN PARTICLE SI"
	    "ZE\002)";
    static char fmt_4[] = "(\0021\002/55x,\002TIME =\002,e12.4/40x,\002*** D"
	    "ISTRIBUTION NEGATIVE AT\rFOLLOWING GRID POINTS\002//(50x,i4,e13."
	    "4))";
    static char fmt_19[] = "(\0021\002/55x,\002TIME =\002,e12.4/40x,\002*** "
	    "CLUSTER CONCENTRATION NEGATIVE AT FOLLOWING SIZES\002//(50x,i4,e"
	    "13.4))";
...
/* Computing MAX */
	    ...
	    aersl4_1.z2[i__ + mw * 24 - 25] = (aersl8_1.wquad[j - 1] * d_sign(
		    &c_b174, &d__1) * (1. - bottom) + 1.f + bottom) * .5;
/* L15: */
...
/* Subroutine */ int steady_(doublereal *time)
{
    ...
    static char fmt_7[] = "(\0020*** STEADY STATE CONVERGENCE TROUBLE, CONTA"
	    "CT FRED GELBARD\002/10x,\002ITERATION\002,i5,3x,\002TIME\002,e12"
	    ".4/(8e15.5))";
...
/* Subroutine */ int check_(integer *istop)
{
    ...
    static char fmt_13[] = "(\0020---NUMERICAL DERIVATIVE OF GROWTH RATE FOR"
	    " SMALLEST PARTICLE AT INITIAL TIME DOES NOT MATCH GIVEN DERIVATI"
	    "VE\002/9x,\002NUMERICAL AND GIVEN DERIVATIVES RESPECTIVELY AR"
	    "E\002,2e15.5)";
    ...
    static char fmt_61[] = "(\0020---FOR PROBLEMS WITH NO COAGULATION IT IS "
	    "BETTER TO USE THE METHOD OF CHARACTERISTICS\002/\002   REF. J. C"
	    "OLLOID AND INTERFACE SCIENCE, V.68, P.173 (1979)\002)";
    ...
    static char fmt_29[] = "(\0020---GRID POINT NUMBER\002,i3,\002 HAS A MUL"
	    "TIPLET NUMBER LESS THAN OR EQUAL TO THE NUMBER OF DISCRETE SIZES"
	    " + 1\002)";
    ...
    static char fmt_39[] = "(\0020---NUMBER OF GRID POINTS GIVEN MUST BE LES"
	    "S THAN OR EQUAL TO THE NUMBER OF TOTAL GRID POINTS\002/9x,\002MI"
	    "NUS THE NUMBER OF MULTIPLETS GIVEN MINUS 2\002)";
...
L28:
    ...
    i__1 = aersl5_1.nprnt;
    for (i__ = 2; i__ <= i__1; ++i__) {
	if (aersl6_2.tout[i__ - 2] > aersl6_2.tout[i__ - 1] || aersl6_2.tout[
		i__ - 2] < 0.) {
	    goto L3;
	}
/* L43: */
...
L53:
    ...
    if ((d__1 = r3 - p1, abs(d__1)) * 100.f < abs(p1)) {
	goto L10;
    }
    *istop = 1;
...
L57:
    ...
    if ((d__1 = r1 - r2, abs(d__1)) * 1e3f <= abs(r1)) {
	goto L50;
    }
    *istop = 1;
...
L5:
    ...
    if (aersl2_1.w[1] > 0.f && aersl2_1.w[aersl5_1.nvarm1 - 1] < 1.) {
	goto L15;
    }
...
/* Subroutine */ int distw_(integer *isplin, integer *nvarm1, integer *npts, 
	doublereal *wx, doublereal *zdist)
{
    /* System generated locals */
    integer i__1, i__2;
...
/* Computing 2nd power */
	...
	zdist[i__] = (aersl7_1.p[j - 2] * (d__1 * (d__1 * d__1)) + aersl7_1.p[
		j - 1] * (d__2 * (d__2 * d__2)) + (aersl2_1.a[j] * 6. - d__3 *
		 d__3 * aersl7_1.p[j - 1]) * (wx[i__] - aersl2_1.w[j - 1]) + (
		aersl2_1.a[j - 1] * 6. - d__4 * d__4 * aersl7_1.p[j - 2]) * (
...
/* Subroutine */ int errchk_(integer *nchars, integer *narray)
{
    ...
    static char fmt_15[] = "(/\002 *** NOTE ***\002/\002 TO MAKE THE ERROR M"
	    "ESSAGE PRINTED ABOVE BE NONFATAL,\002/\002 OR TO SUPPRESS THE ME"
	    "SSAGE COMPLETELY,\002/\002 INSERT AN APPROPRIATE CALL TO ERXSE"
	    "T\002,\002 AT THE START OF YOUR PROGRAM.\002/\002 FOR EXAMPLE, T"
	    "O PRINT UP TO 10 NONFATAL WARNING MESSAGES, USE\002/\002        "
	    "  CALL ERXSET(10,0)\002)";
